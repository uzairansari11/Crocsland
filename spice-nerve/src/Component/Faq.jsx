        ...
        <AccordionItem>
            {({ isExpanded }) => (
                <>
                    ...
                    <AccordionPanel pb={4} textAlign='left'>
                        Crocs at Work™ styles are designed to work as hard as you are. Professionals such as healthcare and hospitality workers can enjoy round-the-clock comfort, slip-resistant technology, and easy to clean material that helps support during every shift. In addition, earlier this year, we supported our healthcare heroes battling COVID-19 by giving away thousands of free shoes during our Sharing a Free Pair for Healthcare giveaway.
                    </AccordionPanel>
                </>
            )}
        </AccordionItem>
